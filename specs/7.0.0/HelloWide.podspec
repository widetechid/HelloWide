Pod::Spec.new do |s|
  ...
  s.swift_version = '5.0'
  s.source = { :http => 'https://maven.primecash.co.id/repository/maven-releases/id/co/widetechnologies/component/mobile/hellowide-ios/7.0.0/hellowide-ios-7.0.0.zip' }
